...
const AvailableStack = ({technologies}) => {
    console.log(technologies, "available stack")
  ...
  <div className="card-body ">
    ...
    <div className=" card-actions">
      <button className="btn btn-primary px-20 py-6 mt-4 bg-orange-500 border-none">Add to Stack</button>
    </div>
  </div>
</div>
                            </div>
